...
### 8.1 为保障网络与信息安全，维护平台稳定运行，我们将对服务运行状态进行监控，并采取必要的技术手段管理网络资源。

### 8.2 您理解并同意，为履行法律法规规定的网络信息安全义务，我们在发现或合理怀疑您存在违法违规行为时，有权采取包括但不限于以下措施：

- 要求您提供相关使用目的的说明
- 限制或切断网络接入
- 保留有关记录，并依法向有关主管部门报告

### 8.3 您承诺配合国家有关主管部门依法进行的监督检查，并授权我们在接到法律法规规定的正式要求时，向监管部门提供您的必要注册信息和使用日志等信息
