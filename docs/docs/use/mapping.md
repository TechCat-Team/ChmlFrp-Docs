...
![主页面截图](./img/mapping//4.png)

点击右上角"添加隧道"

![添加隧道截图](./img/mapping//5.png)
...
![文件夹截图](./img/mapping//windowsfrpc3.png)
...
![frpc.ini文件截图](./img/mapping//windowsfrpc6.png)

在地址栏输入cmd 用当前地址打开命令提示符

输入frpc.exe 打开frpc

![CMD启动截图](./img/mapping//windowsfrpc7.png)
...
![linux下载chmlfrp客户端截图](./img/mapping//15.png)
